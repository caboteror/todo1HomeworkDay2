...
export class AppComponent {
	...
	urlImage = 'http://upload.wikimedia.org/wikipedia/commons/thumb/8/8b/FvfSudipenTagudin5010_36.JPG/500px-FvfSudipenTagudin5010_36.JPG';
	textInput = '';
	users = [
		{
			userId: 1,
	...
	constructor() {
		setTimeout(() => {
			this.urlImage = 'https://cdn4.buysellads.net/uu/1/3332/1524775809-62094.png';
		}, 3000);
	}
	consoleLog(valInput: string) {
		this.textInput = valInput;
	...
	changeOtherTitle(title: string) {
		if (title) {
			this.title = title;
		}
	}

	changeNum1(num: number) {
		if (num) {
			this.num1 = num;
		} else {
			this.num1 = 0;
